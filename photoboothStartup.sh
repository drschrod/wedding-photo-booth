...
tmux send-keys -t BACK.0 \
    'chromium-browser --kiosk --disable-session-crashed-bubble --user-data-dir=/home/pi/Documents/back --window-position=1920,0 --app=http://localhost:3000/#/back' ENTER
tmux send-keys -t FRONT.0 \
    'chromium-browser --kiosk --disable-session-crashed-bubble --user-data-dir=/home/pi/Documents/front --window-position=0,0 --app=http://localhost:3000/#/front' ENTER
